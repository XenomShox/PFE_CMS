                ...
                $.ajax({
                    ...
                    success: (permissions) => {
                        ...
                        let nameInput = $(`<div class="mt-4"></div>`)
                            .append(
                                $(
                                    '<h5 class="text-muted font-weight-bold" >ROLE NAME</h5>'
                                )
                            )
                            .append(
                                $(
                        ...
                        let categoryInput = $(`<div class="mt-4"></div>`)
                            .append(
                                $(
                                    '<h5 class="text-muted font-weight-bold" >ROLE CATEGORY</h5>'
                                )
                            )
                            .append(
                                $(
                        ...
                        let permissionsList = $(
                            ...
                            $(
                                '<h5 class="text-muted font-weight-bold mb-5" >GENERAL PERMISSIONS</h5>'
                            )
                        );
