...
class TemplatesManager {
    ...
    deleteTemplatesFiles ( Template ) {
        let promises = [];
        promises.push( FileManager.DeleteFile( path.join( '/css' , Template.name ) , 'folder' ) )
        promises.push( FileManager.DeleteFile( path.join( '/javascript' , Template.name ) , 'folder' ) )
        promises.push( FileManager.DeleteFile( path.join( '/images' , Template.name ) , 'folder' ) )
        promises.push( FileManager.DeleteFile( path.join( '../views/templates' , Template.name ) , 'folder' ) )
