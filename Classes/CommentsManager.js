...
class CommentsManager {
    ...
    constructor() {
        ...
        //     try{
        //         if(this.post){
        //             let postToFind = await Post.Model.findById(this.id);
        //             postToFind.comments.remove(this.id);
        //             await postToFind.save()
        //         } else if (this.replied_to) {
        //             let postToFind = await this.model.findById(this.id);
        //             postToFind.comments.remove(this.id);
        //             await postToFind.save()
        //         }
        //     }catch(err){
