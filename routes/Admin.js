...
router.route( '/templates/:id' )
    .get( async ( req , res ) => {
        try {
            if ( req.query.load ) {
                return FileManager.ReadFile( req.query.load )
                    .then( file => {
            ...
            if ( req.query.f ) {
                return res.render( 'template/Edit' , { template } , ( err , html ) => {
                    if ( err ) throw err;
    ...
    .put( ( req , res , next ) => {
        try {
            if ( req.query.update ) {
                return FileManager.WriteFile( req.query.update , req.body.data )
                    .then( () => {
