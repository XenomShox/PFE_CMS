...
router.route("/search/")
    .get(async (req, res) => {
        try{
            ...
            res.render(`templates/${req.Schema.name}/${req.Schema.Search}`, {Posts, search} , renderFunction(res) )
        }
        catch (e) { ErrorHandler(req,res,e) }
    })
...
async function PostHandler(req,res,next) {
    ...
    try {
        ...
        if(req.query.edit) res.render(`templates/${req.Schema.name}/${req.Schema.Edit}`,{Post},renderFunction(res));
        else res.render(`templates/${req.Schema.name}/${req.Schema.Post}`,{Post},renderFunction(res));
    }
    catch (e) { ErrorHandler(req,res,e) }
}
